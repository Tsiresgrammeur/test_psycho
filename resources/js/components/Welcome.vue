...
@media (max-width: 650px) {
  .logo-mobile {
    ...
    box-shadow: 1px 3px 22px -10px rgba(70, 70, 70, 0.52);
    -webkit-box-shadow: 1px 3px 22px -10px rgba(46, 46, 46, 0.52);
    -moz-box-shadow: 1px 3px 22px -10px rgba(55, 54, 54, 0.52);
  }
  .logo-desktop {
    display: none;
  }
